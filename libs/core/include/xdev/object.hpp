...
public:
  ...
  XStaticClass(const string &name) : _name(name), _instanceCount(0) {}
  ...
  const xdict &metadata() const { return _metadata; }

  const XMetaPropertyBase::map_t &properties() const { return _properties; }
  ...
  size_t operator++() { return ++_instanceCount; }
...
public:
  ...
  virtual string toString() const { return objectName(); }
  ...
  static constexpr const char *ctti_nameof() { return "XObject"; }
...
public:                                                                                           \
  ...
  static auto Create() { return xdev::XObjectBase::Create<ClassType>(); }                         \
  static xdev::XObjectBase::ptr CreateObject() { return xdev::XObjectBase::Create<ClassType>(); } \
